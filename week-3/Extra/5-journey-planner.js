...
function journeyPlanner(array, transporte) {
  let specificTranport = array.filter(element => element.includes(transporte));
  let result = specificTranport.map(element => element[0]);
  return result;
}
